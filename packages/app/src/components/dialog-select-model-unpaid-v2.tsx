...
// [gp] Product: the first-party free tier is gone, so the featured list is the
// providers a BYOK user is most likely to reach for.
const featuredProviders = ["anthropic", "openai", "github-copilot", "google", "openrouter"]
