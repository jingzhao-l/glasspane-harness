export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "GlassPane Harness कागजात",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness मेनु",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness लोड हुन सकेन",
  "desktop.recovery.terminated": "GlassPane Harness विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "GlassPane Harness ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness स्थापना असफल भयो",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहिले नै थपिएको छ",
  "desktop.wsl.error.harnessMissing": "GlassPane Harness यस distro मा स्थापित छैन",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harness द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र GlassPane Harness मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र GlassPane Harness मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू GlassPane Harness मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.plugins.empty": "glasspane-harness.json मा कन्फिगर गरिएका प्लगइनहरू",
  ...
  "dialog.server.description": "यो एप जडान भएको GlassPane Harness सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness जाँच गर्दै...",
  "wsl.onboarding.checkingHarnessIn": "{{distro}} मा GlassPane Harness जाँच गर्दै...",
  "wsl.onboarding.updatingHarness": "अद्यावधिक गर्दै GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "{{distro}} मा GlassPane Harness अद्यावधिक गर्दै...",
  "wsl.onboarding.updateHarnessIn": "अपडेट गर्नुहोस् GlassPane Harness {{distro}} मा।",
  "wsl.onboarding.updateHarness": "अपडेट गर्नुहोस् GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness {{distro}} मा तयार छ।",
  "wsl.onboarding.harnessReady": "GlassPane Harness तयार छ।",
  "wsl.onboarding.installHarnessIn": "{{distro}} मा GlassPane Harness स्थापना गर्नुहोस्।",
  "wsl.onboarding.installHarness": "GlassPane Harness स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) GlassPane Harness ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि GlassPane Harness पुन: खोल्नुहोस्।",
  ...
  "help.tabs.introduction": "GlassPane Harness डेस्कटप अब ट्याब वरिपरि बनाइएको छ।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness ({{version}}) को नयाँ संस्करण अब स्थापना गर्न उपलब्ध छ।",
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि GlassPane Harness टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.checkConfig": "आफ्नो कन्फिगरेसन (glasspane-harness.json) प्रदायक/मोडेल नामहरू जाँच गर्नुहोस्",
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, GlassPane Harness ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "app.name.desktop": "GlassPane Harness डेस्कटप",
  ...
  "settings.desktop.wsl.description": "GlassPane Harness सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "GlassPane Harness को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा GlassPane Harness कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "GlassPane Harness ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी GlassPane Harness विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं GlassPane Harness को नवीनतम संस्करण चलाइरहनुभएको छ।",
