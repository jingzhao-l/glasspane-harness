export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Plugin configurati in glasspane-harness.json",
  ...
  "dialog.server.description": "Cambia il server GlassPane Harness a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingHarness": "Controllo GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Controllo GlassPane Harness in {{distro}}...",
  "wsl.onboarding.updatingHarness": "Aggiornamento GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Aggiornamento GlassPane Harness in {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Aggiorna GlassPane Harness in {{distro}}.",
  "wsl.onboarding.updateHarness": "Aggiorna GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness è pronto in {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness è pronto.",
  "wsl.onboarding.installHarnessIn": "Installa GlassPane Harness in {{distro}}.",
  "wsl.onboarding.installHarness": "Installa GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che GlassPane Harness possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di GlassPane Harness ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team GlassPane Harness",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (glasspane-harness.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: GlassPane Harness non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server GlassPane Harness all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di GlassPane Harness sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se GlassPane Harness segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di GlassPane Harness",
  ...
  "settings.updates.toast.latest.title": "GlassPane Harness è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di GlassPane Harness.",
  ...
  "desktop.menu.documentation": "Documentazione di GlassPane Harness",
  ...
  "desktop.menu.ariaLabel": "Menu GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare GlassPane Harness",
  "desktop.recovery.terminated": "La finestra di GlassPane Harness si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "GlassPane Harness non risponde",
  ...
  "desktop.wsl.error.installHarness": "Installazione di GlassPane Harness non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.harnessMissing": "glasspane-harness non è installato in questa distribuzione",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di GlassPane Harness è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
