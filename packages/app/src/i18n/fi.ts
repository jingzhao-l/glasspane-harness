export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harnessn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja GlassPane Harnessssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja GlassPane Harnessssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja GlassPane Harnessssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään glasspane-harness.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda GlassPane Harness-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingHarness": "Tarkistetaan GlassPane Harnessa...",
  "wsl.onboarding.checkingHarnessIn": "Tarkistetaan GlassPane Harnessa kohteessa {{distro}}...",
  "wsl.onboarding.updatingHarness": "Päivitetään GlassPane Harnessa...",
  "wsl.onboarding.updatingHarnessIn": "Päivitetään GlassPane Harnessa kohteessa {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Päivitä GlassPane Harness jakelussa {{distro}}.",
  "wsl.onboarding.updateHarness": "Päivitä GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness on valmis jakelussa {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness on valmis.",
  "wsl.onboarding.installHarnessIn": "Asenna GlassPane Harness jakeluun {{distro}}.",
  "wsl.onboarding.installHarness": "Asenna GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harnessa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin GlassPane Harness voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten GlassPane Harness uudelleen.",
  ...
  "toast.update.description": "GlassPane Harnessn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä GlassPane Harness-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (glasspane-harness.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että GlassPane Harness ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita GlassPane Harness-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda GlassPane Harnessn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä GlassPane Harness näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö GlassPane Harness järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta GlassPane Harnessn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun GlassPane Harness käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät GlassPane Harnessn uusinta versiota.",
  ...
  "desktop.menu.documentation": "GlassPane Harness-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness-valikko",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harnessn lataaminen epäonnistui",
  "desktop.recovery.terminated": "GlassPane Harness-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "GlassPane Harness ei vastaa",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harnessn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.harnessMissing": "glasspane-harnessa ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harnessa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harnessn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
