export const dict = {
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness yüklənə bilmədi",
  "desktop.recovery.terminated": "GlassPane Harness pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "GlassPane Harness cavab vermir",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.harnessMissing": "Bu distribütivdə glasspane-harness quraşdırılmayıb",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harness tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və GlassPane Harness-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və GlassPane Harness-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və GlassPane Harness-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər glasspane-harness.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu GlassPane Harness serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness yoxlanılır...",
  "wsl.onboarding.checkingHarnessIn": "{{distro}}-də GlassPane Harness yoxlanılır...",
  "wsl.onboarding.updatingHarness": "GlassPane Harness yenilənir...",
  "wsl.onboarding.updatingHarnessIn": "{{distro}}-də GlassPane Harness yenilənir...",
  "wsl.onboarding.updateHarnessIn": "{{distro}}-də GlassPane Harness-u yeniləyin.",
  "wsl.onboarding.updateHarness": "GlassPane Harness-u yeniləyin",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness {{distro}}-də hazırdır.",
  "wsl.onboarding.harnessReady": "GlassPane Harness hazırdır.",
  "wsl.onboarding.installHarnessIn": "GlassPane Harness-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installHarness": "GlassPane Harness quraşdırın",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "GlassPane Harness WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra GlassPane Harness-u yenidən açın.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı GlassPane Harness komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (glasspane-harness.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: GlassPane Harness hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində GlassPane Harness serverini işlət.",
  ...
  "settings.general.row.language.description": "GlassPane Harness üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "GlassPane Harness-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "GlassPane Harness-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "GlassPane Harness-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "GlassPane Harness-un ən son versiyasından istifadə edirsiniz.",
