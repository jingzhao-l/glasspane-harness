export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness μενού",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "GlassPane Harness το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "GlassPane Harness δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.harnessMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.harnessCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο glasspane-harness.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή GlassPane Harness συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingHarness": "Έλεγχος GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Έλεγχος GlassPane Harness σε {{distro}}...",
  "wsl.onboarding.updatingHarness": "Ενημέρωση GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Ενημέρωση GlassPane Harness σε {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Ενημέρωση GlassPane Harness σε {{distro}}.",
  "wsl.onboarding.updateHarness": "Ενημέρωση GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness είναι έτοιμο.",
  "wsl.onboarding.installHarnessIn": "Εγκατάσταση του GlassPane Harness στο {{distro}}.",
  "wsl.onboarding.installHarness": "Εγκατάσταση GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο GlassPane Harness να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του GlassPane Harness ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα GlassPane Harness",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (glasspane-harness.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το GlassPane Harness δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "GlassPane Harness Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή GlassPane Harness μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του GlassPane Harness στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το GlassPane Harness ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του GlassPane Harness",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του GlassPane Harness.",
