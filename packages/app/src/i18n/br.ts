export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do GlassPane Harness",
  ...
  "desktop.menu.ariaLabel": "Menu do GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o GlassPane Harness",
  "desktop.recovery.terminated": "A janela do GlassPane Harness foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O GlassPane Harness não está respondendo",
  ...
  "desktop.wsl.error.installHarness": "Falha na instalação do GlassPane Harness",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.harnessMissing": "O glasspane-harness não está instalado nesta distribuição",
  "desktop.wsl.error.harnessCannotRun": "O glasspane-harness está instalado, mas não pôde ser executado",
  "desktop.wsl.error.harnessNotInstalled": "O GlassPane Harness não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do GlassPane Harness foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Plugins configurados em glasspane-harness.json",
  ...
  "dialog.server.description": "Trocar para qual servidor GlassPane Harness este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingHarness": "Verificando o GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Verificando o GlassPane Harness em {{distro}}...",
  "wsl.onboarding.updatingHarness": "Atualizando o GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Atualizando o GlassPane Harness em {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Atualize o GlassPane Harness em {{distro}}.",
  "wsl.onboarding.updateHarness": "Atualizar o GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "O GlassPane Harness está pronto em {{distro}}.",
  "wsl.onboarding.harnessReady": "O GlassPane Harness está pronto.",
  "wsl.onboarding.installHarnessIn": "Instale o GlassPane Harness em {{distro}}.",
  "wsl.onboarding.installHarness": "Instalar o GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o GlassPane Harness possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O GlassPane Harness não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o GlassPane Harness novamente.",
  ...
  "help.tabs.introduction": "Agora, o GlassPane Harness Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do GlassPane Harness ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do GlassPane Harness",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (glasspane-harness.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: GlassPane Harness ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor GlassPane Harness dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Personalize como o GlassPane Harness aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o GlassPane Harness segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o GlassPane Harness é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o GlassPane Harness iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do GlassPane Harness.",
