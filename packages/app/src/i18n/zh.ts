...
export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness 文档",
  "desktop.menu.supportForum": "支持论坛",
  "desktop.menu.shareFeedback": "提供反馈",
  "desktop.menu.reportBug": "报告错误",
  "desktop.menu.ariaLabel": "GlassPane Harness 菜单",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness 加载失败",
  "desktop.recovery.terminated": "GlassPane Harness 窗口意外终止",
  "desktop.recovery.unresponsive": "GlassPane Harness 未响应",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.harnessMissing": "此发行版中未安装 glasspane-harness",
  "desktop.wsl.error.harnessCannotRun": "已安装 glasspane-harness，但无法运行",
  "desktop.wsl.error.harnessNotInstalled": "{{distro}} 中未安装 GlassPane Harness",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harness 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 GlassPane Harness 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 GlassPane Harness 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 GlassPane Harness 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 glasspane-harness.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 GlassPane Harness 服务器。",
  ...
  "wsl.onboarding.checkingHarness": "正在检查 GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "正在检查 {{distro}} 中的 GlassPane Harness...",
  "wsl.onboarding.updatingHarness": "正在更新 GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "正在更新 {{distro}} 中的 GlassPane Harness...",
  "wsl.onboarding.updateHarnessIn": "更新 {{distro}} 中的 GlassPane Harness。",
  "wsl.onboarding.updateHarness": "更新 GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "{{distro}} 中的 GlassPane Harness 已就绪。",
  "wsl.onboarding.harnessReady": "GlassPane Harness 已就绪。",
  "wsl.onboarding.installHarnessIn": "在 {{distro}} 中安装 GlassPane Harness。",
  "wsl.onboarding.installHarness": "安装 GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "未安装 GlassPane Harness",
  ...
  "wsl.onboarding.wslNotInstalled.description": "GlassPane Harness 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 GlassPane Harness。",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 GlassPane Harness 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (glasspane-harness.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：GlassPane Harness 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 GlassPane Harness 服务器。",
  ...
  "settings.general.row.language.description": "更改 GlassPane Harness 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 GlassPane Harness 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 GlassPane Harness 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 GlassPane Harness 的主题。",
  ...
  "settings.updates.row.startup.description": "在 GlassPane Harness 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 GlassPane Harness。",
