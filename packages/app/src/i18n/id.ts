export const dict = {
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness gagal dimuat",
  "desktop.recovery.terminated": "Jendela GlassPane Harness berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "GlassPane Harness tidak merespons",
  ...
  "desktop.wsl.error.installHarness": "Instalasi GlassPane Harness gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.harnessMissing": "glasspane-harness belum terinstal di distro ini",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan GlassPane Harness selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di glasspane-harness.json",
  ...
  "dialog.server.description": "Ganti server GlassPane Harness mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingHarness": "Memeriksa GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Memeriksa GlassPane Harness di {{distro}}...",
  "wsl.onboarding.updatingHarness": "Memperbarui GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Memperbarui GlassPane Harness di {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Perbarui GlassPane Harness di {{distro}}.",
  "wsl.onboarding.updateHarness": "Perbarui GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness siap di {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness siap.",
  "wsl.onboarding.installHarnessIn": "Instal GlassPane Harness di {{distro}}.",
  "wsl.onboarding.installHarness": "Instal GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum GlassPane Harness dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru GlassPane Harness ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim GlassPane Harness",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (glasspane-harness.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: GlassPane Harness belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server GlassPane Harness di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan GlassPane Harness di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah GlassPane Harness mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat GlassPane Harness diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru GlassPane Harness.",
