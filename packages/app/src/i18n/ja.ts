export const dict = {
  ...
  "desktop.recovery.loadFailed": "GlassPane Harnessを読み込めませんでした",
  "desktop.recovery.terminated": "GlassPane Harnessのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "GlassPane Harnessが応答していません",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harnessのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.harnessMissing": "このディストリビューションにはglasspane-harnessがインストールされていません",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harnessはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.harnessNotInstalled": "{{distro}}にはGlassPane Harnessがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harnessのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harnessが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、GlassPane Harnessで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してGlassPane Harnessで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、GlassPane Harnessで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "glasspane-harness.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するGlassPane Harnessサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harnessを確認中...",
  "wsl.onboarding.checkingHarnessIn": "{{distro}}内のGlassPane Harnessを確認中...",
  "wsl.onboarding.updatingHarness": "GlassPane Harnessを更新中...",
  "wsl.onboarding.updatingHarnessIn": "{{distro}}内のGlassPane Harnessを更新中...",
  "wsl.onboarding.updateHarnessIn": "{{distro}}内のGlassPane Harnessを更新してください。",
  "wsl.onboarding.updateHarness": "GlassPane Harnessを更新",
  "wsl.onboarding.harnessReadyIn": "{{distro}}内のGlassPane Harnessの準備ができました。",
  "wsl.onboarding.harnessReady": "GlassPane Harnessの準備ができました。",
  "wsl.onboarding.installHarnessIn": "{{distro}}にGlassPane Harnessをインストールしてください。",
  "wsl.onboarding.installHarness": "GlassPane Harnessをインストール",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harnessがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "GlassPane HarnessでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、GlassPane Harnessをもう一度開いてください。",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harnessの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをGlassPane Harnessチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (glasspane-harness.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: GlassPane HarnessはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harnessには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でGlassPane Harnessサーバーを実行します。",
  ...
  "settings.general.row.language.description": "GlassPane Harnessの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのGlassPane Harnessの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "GlassPane Harnessがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "GlassPane Harnessのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "GlassPane Harness は最新バージョンです。",
