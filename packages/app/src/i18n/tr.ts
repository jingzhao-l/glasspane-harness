...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness yüklenemedi",
  "desktop.recovery.terminated": "GlassPane Harness penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "GlassPane Harness yanıt vermiyor",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.harnessMissing": "glasspane-harness bu dağıtımda kurulu değil",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harness tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve GlassPane Harness'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak GlassPane Harness'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak GlassPane Harness'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler glasspane-harness.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi GlassPane Harness sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness kontrol ediliyor...",
  "wsl.onboarding.checkingHarnessIn": "{{distro}} içinde GlassPane Harness kontrol ediliyor...",
  "wsl.onboarding.updatingHarness": "GlassPane Harness güncelleniyor...",
  "wsl.onboarding.updatingHarnessIn": "{{distro}} içinde GlassPane Harness güncelleniyor...",
  "wsl.onboarding.updateHarnessIn": "{{distro}} içindeki GlassPane Harness'u güncelleyin.",
  "wsl.onboarding.updateHarness": "GlassPane Harness'u güncelle",
  "wsl.onboarding.harnessReadyIn": "{{distro}} içinde GlassPane Harness hazır.",
  "wsl.onboarding.harnessReady": "GlassPane Harness hazır.",
  "wsl.onboarding.installHarnessIn": "GlassPane Harness'u {{distro}} içine kurun.",
  "wsl.onboarding.installHarness": "GlassPane Harness'u kur",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "GlassPane Harness'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından GlassPane Harness'u tekrar açın.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı GlassPane Harness ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (glasspane-harness.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: GlassPane Harness henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "GlassPane Harness Masaüstü",
  ...
  "settings.desktop.wsl.description": "GlassPane Harness sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "GlassPane Harness'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "GlassPane Harness'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "GlassPane Harness'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "GlassPane Harness'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "GlassPane Harness'un en son sürümünü kullanıyorsunuz.",
