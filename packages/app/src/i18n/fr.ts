export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'GlassPane Harness",
  "desktop.recovery.terminated": "La fenêtre GlassPane Harness s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "GlassPane Harness ne répond pas",
  ...
  "desktop.wsl.error.installHarness": "Échec de l'installation d'GlassPane Harness",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.harnessMissing": "glasspane-harness n'est pas installé dans cette distribution",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'GlassPane Harness est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans glasspane-harness.json",
  ...
  "dialog.server.description": "Changez le serveur GlassPane Harness auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingHarness": "Vérification d'GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Vérification d'GlassPane Harness dans {{distro}}...",
  "wsl.onboarding.updatingHarness": "Mise à jour d'GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Mise à jour d'GlassPane Harness dans {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Mettez à jour GlassPane Harness dans {{distro}}.",
  "wsl.onboarding.updateHarness": "Mettre à jour GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness est prêt dans {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness est prêt.",
  "wsl.onboarding.installHarnessIn": "Installez GlassPane Harness dans {{distro}}.",
  "wsl.onboarding.installHarness": "Installer GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'GlassPane Harness puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'GlassPane Harness ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe GlassPane Harness",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (glasspane-harness.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'GlassPane Harness ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "GlassPane Harness inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur GlassPane Harness dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'GlassPane Harness sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si GlassPane Harness suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'GlassPane Harness",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'GlassPane Harness.",
