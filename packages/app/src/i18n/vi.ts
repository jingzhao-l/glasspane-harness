export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "Không tải được GlassPane Harness",
  "desktop.recovery.terminated": "Cửa sổ GlassPane Harness đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "GlassPane Harness không phản hồi",
  ...
  "desktop.wsl.error.installHarness": "Không cài đặt được GlassPane Harness",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.harnessMissing": "glasspane-harness chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật GlassPane Harness nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do GlassPane Harness cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong glasspane-harness.json",
  ...
  "dialog.server.description": "Chuyển máy chủ GlassPane Harness mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingHarness": "Đang kiểm tra GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Đang kiểm tra GlassPane Harness trong {{distro}}...",
  "wsl.onboarding.updatingHarness": "Đang cập nhật GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Đang cập nhật GlassPane Harness trong {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Cập nhật GlassPane Harness trong {{distro}}.",
  "wsl.onboarding.updateHarness": "Cập nhật GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness đã sẵn sàng.",
  "wsl.onboarding.installHarnessIn": "Cài đặt GlassPane Harness trong {{distro}}.",
  "wsl.onboarding.installHarness": "Cài đặt GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi GlassPane Harness có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của GlassPane Harness ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm GlassPane Harness",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (glasspane-harness.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: GlassPane Harness chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ GlassPane Harness bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của GlassPane Harness trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem GlassPane Harness tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi GlassPane Harness khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của GlassPane Harness.",
