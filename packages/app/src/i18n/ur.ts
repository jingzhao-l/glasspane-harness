export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness دستاویزات",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness مینو",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "GlassPane Harness ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "GlassPane Harness جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.harnessMissing": "اس ڈسٹری بیوشن میں glasspane-harness انسٹال نہیں ہے",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.harnessNotInstalled": "{{distro}} میں GlassPane Harness انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harness کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور GlassPane Harness میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور GlassPane Harness میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور GlassPane Harness میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "glasspane-harness.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس GlassPane Harness سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingHarnessIn": "{{distro}} میں GlassPane Harness چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingHarness": "GlassPane Harness کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingHarnessIn": "{{distro}} میں GlassPane Harness کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateHarnessIn": "{{distro}} میں GlassPane Harness کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateHarness": "GlassPane Harness کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness {{distro}} میں تیار ہے۔",
  "wsl.onboarding.harnessReady": "GlassPane Harness تیار ہے۔",
  "wsl.onboarding.installHarnessIn": "{{distro}} میں GlassPane Harness انسٹال کریں۔",
  "wsl.onboarding.installHarness": "GlassPane Harness انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ GlassPane Harness WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر GlassPane Harness کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم GlassPane Harness ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (glasspane-harness.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، GlassPane Harness ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "GlassPane Harness ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر GlassPane Harness سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "GlassPane Harness کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر GlassPane Harness کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا GlassPane Harness سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "GlassPane Harness کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ GlassPane Harness کا تازہ ترین ورژن چلا رہے ہیں۔",
