export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness-documentatie",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness kan niet worden geladen",
  "desktop.recovery.terminated": "Het GlassPane Harness-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "GlassPane Harness reageert niet",
  ...
  "desktop.wsl.error.installHarness": "Installatie van GlassPane Harness is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.harnessMissing": "glasspane-harness is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De GlassPane Harness-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in GlassPane Harness te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in GlassPane Harness te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in GlassPane Harness te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in glasspane-harness.json",
  ...
  "dialog.server.description": "Wijzig met welke GlassPane Harness-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness controleren...",
  "wsl.onboarding.checkingHarnessIn": "GlassPane Harness controleren in {{distro}}...",
  "wsl.onboarding.updatingHarness": "GlassPane Harness bijwerken...",
  "wsl.onboarding.updatingHarnessIn": "GlassPane Harness bijwerken in {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Werk GlassPane Harness bij in {{distro}}.",
  "wsl.onboarding.updateHarness": "GlassPane Harness bijwerken",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness is gereed in {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness is klaar.",
  "wsl.onboarding.installHarnessIn": "Installeer GlassPane Harness in {{distro}}.",
  "wsl.onboarding.installHarness": "Installeer GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat GlassPane Harness een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens GlassPane Harness opnieuw.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van GlassPane Harness ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het GlassPane Harness-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (glasspane-harness.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: GlassPane Harness ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de GlassPane Harness-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe GlassPane Harness eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of GlassPane Harness het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van GlassPane Harness aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer GlassPane Harness wordt gestart",
  ...
  "settings.updates.toast.latest.title": "GlassPane Harness is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van GlassPane Harness.",
