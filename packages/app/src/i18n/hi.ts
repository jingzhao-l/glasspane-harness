export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness मेन्यू",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness लोड नहीं हो सका",
  "desktop.recovery.terminated": "GlassPane Harness विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "GlassPane Harness प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.harnessMissing": "इस डिस्ट्रो में glasspane-harness इंस्टॉल नहीं है",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.harnessNotInstalled": "{{distro}} में GlassPane Harness इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harness द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और GlassPane Harness में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और GlassPane Harness में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा GlassPane Harness में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन glasspane-harness.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस GlassPane Harness सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness की जाँच हो रही है...",
  "wsl.onboarding.checkingHarnessIn": "{{distro}} में GlassPane Harness की जाँच हो रही है...",
  "wsl.onboarding.updatingHarness": "GlassPane Harness अपडेट हो रहा है...",
  "wsl.onboarding.updatingHarnessIn": "{{distro}} में GlassPane Harness अपडेट हो रहा है...",
  "wsl.onboarding.updateHarnessIn": "{{distro}} में GlassPane Harness को अपडेट करें।",
  "wsl.onboarding.updateHarness": "GlassPane Harness को अपडेट करें",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness {{distro}} में तैयार है।",
  "wsl.onboarding.harnessReady": "GlassPane Harness तैयार है।",
  "wsl.onboarding.installHarnessIn": "{{distro}} में GlassPane Harness स्थापित करें।",
  "wsl.onboarding.installHarness": "GlassPane Harness स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "GlassPane Harness द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर GlassPane Harness को फिर से खोलें।",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट GlassPane Harness टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (glasspane-harness.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, GlassPane Harness अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर GlassPane Harness सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "GlassPane Harness के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि GlassPane Harness आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि GlassPane Harness सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि GlassPane Harness की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप GlassPane Harness का नवीनतम संस्करण चला रहे हैं।",
