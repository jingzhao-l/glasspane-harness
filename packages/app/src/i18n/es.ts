export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de GlassPane Harness",
  ...
  "desktop.menu.ariaLabel": "Menú de GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar GlassPane Harness",
  "desktop.recovery.terminated": "La ventana de GlassPane Harness se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "GlassPane Harness no responde",
  ...
  "desktop.wsl.error.installHarness": "No se pudo instalar GlassPane Harness",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.harnessMissing": "glasspane-harness no está instalado en esta distribución",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de GlassPane Harness finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Plugins configurados en glasspane-harness.json",
  ...
  "dialog.server.description": "Cambiar el servidor de GlassPane Harness al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingHarness": "Comprobando GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Comprobando GlassPane Harness en {{distro}}...",
  "wsl.onboarding.updatingHarness": "Actualizando GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Actualizando GlassPane Harness en {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Actualiza GlassPane Harness en {{distro}}.",
  "wsl.onboarding.updateHarness": "Actualizar GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness está listo en {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness está listo.",
  "wsl.onboarding.installHarnessIn": "Instala GlassPane Harness en {{distro}}.",
  "wsl.onboarding.installHarness": "Instalar GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que GlassPane Harness pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de GlassPane Harness ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de GlassPane Harness",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (glasspane-harness.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: GlassPane Harness aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor GlassPane Harness dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve GlassPane Harness en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si GlassPane Harness sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia GlassPane Harness",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de GlassPane Harness.",
