export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل GlassPane Harness",
  "desktop.recovery.terminated": "توقفت نافذة GlassPane Harness بشكل غير متوقع",
  "desktop.recovery.unresponsive": "GlassPane Harness لا يستجيب",
  ...
  "desktop.wsl.error.installHarness": "فشل تثبيت GlassPane Harness",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.harnessMissing": "glasspane-harness غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث GlassPane Harness، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في GlassPane Harness.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في glasspane-harness.json",
  ...
  "dialog.server.description": "تبديل خادم GlassPane Harness الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingHarness": "جارٍ التحقق من GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "جارٍ التحقق من GlassPane Harness في {{distro}}...",
  "wsl.onboarding.updatingHarness": "جارٍ تحديث GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "جارٍ تحديث GlassPane Harness في {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "حدّث GlassPane Harness في {{distro}}.",
  "wsl.onboarding.updateHarness": "تحديث GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness جاهز في {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness جاهز.",
  "wsl.onboarding.installHarnessIn": "ثبّت GlassPane Harness في {{distro}}.",
  "wsl.onboarding.installHarness": "تثبيت GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن GlassPane Harness من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على GlassPane Harness التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح GlassPane Harness.",
  ...
  "help.tabs.introduction": "أصبح GlassPane Harness Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من GlassPane Harness ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق GlassPane Harness",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (glasspane-harness.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن GlassPane Harness لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن GlassPane Harness نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم GlassPane Harness داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور GlassPane Harness على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان GlassPane Harness يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل GlassPane Harness",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من GlassPane Harness.",
