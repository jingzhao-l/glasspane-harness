export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "GlassPane Harness ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness মেনু",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "GlassPane Harness উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "GlassPane Harness সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness ইনস্টলেশন ব্যর্থ হয়েছে৷",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ইতিমধ্যেই যোগ করা হয়েছে৷",
  "desktop.wsl.error.harnessMissing": "এই ডিস্ট্রোতে glasspane-harness ইনস্টল করা নেই",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি GlassPane Harness দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং GlassPane Harness-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি GlassPane Harness-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি GlassPane Harness-এ ব্যবহার করুন৷",
  ...
  "dialog.plugins.empty": "glasspane-harness.json এ কনফিগার করা প্লাগইন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন GlassPane Harness সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingHarnessIn": "{{distro}} এ GlassPane Harness চেক করা হচ্ছে...",
  "wsl.onboarding.updatingHarness": "আপডেট করা হচ্ছে GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "{{distro}}-এ GlassPane Harness আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateHarnessIn": "{{distro}}-এ GlassPane Harness আপডেট করুন।",
  "wsl.onboarding.updateHarness": "GlassPane Harness আপডেট করুন",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.harnessReady": "GlassPane Harness প্রস্তুত।",
  "wsl.onboarding.installHarnessIn": "{{distro}}-এ GlassPane Harness ইনস্টল করুন।",
  "wsl.onboarding.installHarness": "GlassPane Harness ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) GlassPane Harness একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর GlassPane Harness আবার খুলুন।",
  ...
  "help.tabs.introduction": "GlassPane Harness ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি GlassPane Harness টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (glasspane-harness.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, GlassPane Harness এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "GlassPane Harness ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে GlassPane Harness সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "GlassPane Harness-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে GlassPane Harness কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "GlassPane Harness সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে GlassPane Harness থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি GlassPane Harness এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
