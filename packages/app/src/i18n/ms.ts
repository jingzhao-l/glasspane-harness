export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap GlassPane Harness ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "GlassPane Harness tidak memberi respons",
  ...
  "desktop.wsl.error.installHarness": "Pemasangan GlassPane Harness gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.harnessMissing": "glasspane-harness tidak dipasang dalam distro ini",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini GlassPane Harness selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam glasspane-harness.json",
  ...
  "dialog.server.description": "Tukar pelayan GlassPane Harness yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingHarness": "Sedang menyemak GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Sedang menyemak GlassPane Harness dalam {{distro}}...",
  "wsl.onboarding.updatingHarness": "Sedang mengemas kini GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Sedang mengemas kini GlassPane Harness dalam {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Kemas kini GlassPane Harness dalam {{distro}}.",
  "wsl.onboarding.updateHarness": "Kemas kini GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness sedia digunakan.",
  "wsl.onboarding.installHarnessIn": "Pasang GlassPane Harness dalam {{distro}}.",
  "wsl.onboarding.installHarness": "Pasang GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum GlassPane Harness boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu GlassPane Harness ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan GlassPane Harness",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (glasspane-harness.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, GlassPane Harness belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan GlassPane Harness dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa GlassPane Harness pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada GlassPane Harness mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila GlassPane Harness dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini GlassPane Harness.",
