...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in GlassPane Harness zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in GlassPane Harness zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in GlassPane Harness zu nutzen.",
  ...
  "dialog.plugins.empty": "In glasspane-harness.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den GlassPane Harness-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.harness": "GlassPane Harness",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness wird geprüft…",
  "wsl.onboarding.checkingHarnessIn": "GlassPane Harness in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingHarness": "GlassPane Harness wird aktualisiert…",
  "wsl.onboarding.updatingHarnessIn": "GlassPane Harness in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateHarnessIn": "Aktualisieren Sie GlassPane Harness in {{distro}}.",
  "wsl.onboarding.updateHarness": "GlassPane Harness aktualisieren",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness ist in {{distro}} bereit.",
  "wsl.onboarding.harnessReady": "GlassPane Harness ist bereit.",
  "wsl.onboarding.installHarnessIn": "Installieren Sie GlassPane Harness in {{distro}}.",
  "wsl.onboarding.installHarness": "GlassPane Harness installieren",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor GlassPane Harness einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann GlassPane Harness erneut.",
  ...
  "toast.update.description": "Eine neue Version von GlassPane Harness ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem GlassPane Harness-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (glasspane-harness.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: GlassPane Harness unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "GlassPane Harness mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "GlassPane Harness Desktop",
  ...
  "settings.desktop.wsl.description": "GlassPane Harness-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für GlassPane Harness ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie GlassPane Harness auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob GlassPane Harness dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von GlassPane Harness anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von GlassPane Harness automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "GlassPane Harness ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von GlassPane Harness wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das GlassPane Harness-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "GlassPane Harness reagiert nicht",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.harnessMissing": "glasspane-harness ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das GlassPane Harness-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
