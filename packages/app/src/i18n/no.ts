...
export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness-meny",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness kunne ikke lastes inn",
  "desktop.recovery.terminated": "GlassPane Harness-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "GlassPane Harness svarer ikke",
  ...
  "desktop.wsl.error.installHarness": "Installasjonen av GlassPane Harness mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.harnessMissing": "glasspane-harness er ikke installert i denne distribusjonen",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness er installert, men kunne ikke kjøres",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av GlassPane Harness er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i glasspane-harness.json",
  ...
  "dialog.server.description": "Bytt hvilken GlassPane Harness-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av GlassPane Harness ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til GlassPane Harness-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (glasspane-harness.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at GlassPane Harness ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør GlassPane Harness-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for GlassPane Harness",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan GlassPane Harness ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om GlassPane Harness skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når GlassPane Harness starter",
  ...
  "settings.updates.toast.latest.title": "GlassPane Harness er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av GlassPane Harness.",
  ...
  "wsl.onboarding.checkingHarness": "Sjekker GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Sjekker GlassPane Harness i {{distro}}...",
  "wsl.onboarding.updatingHarness": "Oppdaterer GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Oppdaterer GlassPane Harness i {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Oppdater GlassPane Harness i {{distro}}.",
  "wsl.onboarding.updateHarness": "Oppdater GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness er klar i {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness er klar.",
  "wsl.onboarding.installHarnessIn": "Installer GlassPane Harness i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før GlassPane Harness kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter GlassPane Harness på nytt.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
