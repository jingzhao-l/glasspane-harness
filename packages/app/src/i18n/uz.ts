export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness hujjatlari",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness menyusi",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness yuklanmadi",
  "desktop.recovery.terminated": "GlassPane Harness oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "GlassPane Harness javob bermayapti",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.harnessMissing": "GlassPane Harness ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harness tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va GlassPane Harness’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va GlassPane Harness da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va GlassPane Harness da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "glasspane-harness.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi GlassPane Harness serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness tekshirilmoqda...",
  "wsl.onboarding.checkingHarnessIn": "GlassPane Harness {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingHarness": "GlassPane Harness yangilanmoqda...",
  "wsl.onboarding.updatingHarnessIn": "GlassPane Harness {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateHarnessIn": "GlassPane Harness-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateHarness": "GlassPane Harness-ni yangilang",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness {{distro}} da tayyor.",
  "wsl.onboarding.harnessReady": "GlassPane Harness tayyor.",
  "wsl.onboarding.installHarnessIn": "GlassPane Harness-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installHarness": "GlassPane Harness-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "GlassPane Harness WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra GlassPane Harness-ni qayta oching.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida GlassPane Harness jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (glasspane-harness.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, GlassPane Harness hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "GlassPane Harness bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi GlassPane Harness serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "GlassPane Harness uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "GlassPane Harness qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "GlassPane Harness tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "GlassPane Harness mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz GlassPane Harness oxirgi versiyasini ishga tushiryapsiz.",
