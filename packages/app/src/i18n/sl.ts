export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno GlassPane Harness se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "GlassPane Harness se ne odziva",
  ...
  "desktop.wsl.error.installHarness": "Namestitev GlassPane Harness ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.harnessMissing": "glasspane-harness ni nameščen v tej distribuciji",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev GlassPane Harness je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v glasspane-harness.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom GlassPane Harness se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingHarness": "Preverjanje GlassPane Harness ...",
  "wsl.onboarding.checkingHarnessIn": "Preverjanje GlassPane Harness v {{distro}} ...",
  "wsl.onboarding.updatingHarness": "Posodabljanje GlassPane Harness ...",
  "wsl.onboarding.updatingHarnessIn": "Posodabljanje GlassPane Harness v {{distro}} ...",
  "wsl.onboarding.updateHarnessIn": "Posodobite GlassPane Harness v {{distro}}.",
  "wsl.onboarding.updateHarness": "Posodobite GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness je pripravljen v {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness je pripravljen.",
  "wsl.onboarding.installHarnessIn": "Namestite GlassPane Harness v {{distro}}.",
  "wsl.onboarding.installHarness": "Namestite GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko GlassPane Harness doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica GlassPane Harness ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi GlassPane Harness",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (glasspane-harness.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, GlassPane Harness še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik GlassPane Harness znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako GlassPane Harness izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali GlassPane Harness sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene GlassPane Harness",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico GlassPane Harness.",
