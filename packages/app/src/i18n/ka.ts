export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness მენიუ",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "GlassPane Harness ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "GlassPane Harness არ პასუხობს",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.harnessMissing": "glasspane-harness არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები GlassPane Harness-ში.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები GlassPane Harness-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები GlassPane Harness-ში.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია glasspane-harness.json-ში",
  ...
  "dialog.server.description": "გადართეთ რომელ GlassPane Harness სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingHarness": "შემოწმებულია GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "შემოწმებულია GlassPane Harness-ში {{distro}}...",
  "wsl.onboarding.updatingHarness": "განახლება GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "GlassPane Harness განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "განახლება GlassPane Harness {{distro}}-ში.",
  "wsl.onboarding.updateHarness": "განახლება GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness მზად არის {{distro}}-ში.",
  "wsl.onboarding.harnessReady": "GlassPane Harness მზად არის.",
  "wsl.onboarding.installHarnessIn": "დააინსტალირეთ GlassPane Harness {{distro}}-ში.",
  "wsl.onboarding.installHarness": "დააინსტალირეთ GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ GlassPane Harness შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა GlassPane Harness გუნდს",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (glasspane-harness.json) პროვაიდერის/მოდელების სახელები",
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, GlassPane Harness ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "GlassPane Harness სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით GlassPane Harness სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება GlassPane Harness თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა GlassPane Harness სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის GlassPane Harness თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც GlassPane Harness გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ GlassPane Harness-ის უახლეს ვერსიას.",
