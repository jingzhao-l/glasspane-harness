export const dict = {
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness መጫን አልቻለም",
  "desktop.recovery.terminated": "GlassPane Harness መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "GlassPane Harness ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harnessመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.harnessMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.harnessCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በGlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በGlassPane Harness ይጠቀሙ።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በGlassPane Harness ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በGlassPane Harness ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ glasspane-harness.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው GlassPane Harness አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingHarness": "መፈተሽ GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "GlassPane Harnessን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingHarness": "በማዘመን ላይ GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "በማዘመን ላይ GlassPane Harness በ{{distro}}...",
  "wsl.onboarding.updateHarnessIn": "አዘምን GlassPane Harness በ{{distro}}።",
  "wsl.onboarding.updateHarness": "አዘምን GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.harnessReady": "GlassPane Harness ዝግጁ ነው።",
  "wsl.onboarding.installHarnessIn": "መጫን GlassPane Harness በ{{distro}} ውስጥ።",
  "wsl.onboarding.installHarness": "ጫን GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harnessአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) GlassPane Harness WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ GlassPane Harness።",
  ...
  "help.tabs.introduction": "GlassPane Harness ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የGlassPane Harness ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለGlassPane Harness ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (glasspane-harness.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ GlassPane Harness እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "GlassPane Harness ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የGlassPane Harness አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለGlassPane Harness",
  ...
  "settings.general.row.appearance.description": "GlassPane Harnessበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "GlassPane Harness ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "GlassPane Harness ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "GlassPane Harness ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የGlassPane Harness እትም እያሄዱ ነው።",
