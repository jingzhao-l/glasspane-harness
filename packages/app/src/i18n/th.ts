export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด GlassPane Harness ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง GlassPane Harness หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "GlassPane Harness ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installHarness": "การติดตั้ง GlassPane Harness ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.harnessMissing": "ไม่ได้ติดตั้ง glasspane-harness ในดิสโทรนี้",
  "desktop.wsl.error.harnessCannotRun": "ติดตั้ง glasspane-harness แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.harnessNotInstalled": "ไม่ได้ติดตั้ง GlassPane Harness ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต GlassPane Harness เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน GlassPane Harness",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน GlassPane Harness",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน GlassPane Harness",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน glasspane-harness.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ GlassPane Harness ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingHarness": "กำลังตรวจสอบ GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "กำลังตรวจสอบ GlassPane Harness ใน {{distro}}...",
  "wsl.onboarding.updatingHarness": "กำลังอัปเดต GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "กำลังอัปเดต GlassPane Harness ใน {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "อัปเดต GlassPane Harness ใน {{distro}}",
  "wsl.onboarding.updateHarness": "อัปเดต GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.harnessReady": "GlassPane Harness พร้อมใช้งานแล้ว",
  "wsl.onboarding.installHarnessIn": "ติดตั้ง GlassPane Harness ใน {{distro}}",
  "wsl.onboarding.installHarness": "ติดตั้ง GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "ยังไม่ได้ติดตั้ง GlassPane Harness",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ GlassPane Harness จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด GlassPane Harness อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ GlassPane Harness Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ GlassPane Harness ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม GlassPane Harness",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (glasspane-harness.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า GlassPane Harness ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ GlassPane Harness ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ GlassPane Harness บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ GlassPane Harness ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ GlassPane Harness",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ GlassPane Harness เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน GlassPane Harness เวอร์ชันล่าสุด",
