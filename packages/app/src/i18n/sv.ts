export const dict = {
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness kunde inte läsas in",
  "desktop.recovery.terminated": "GlassPane Harness-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "GlassPane Harness svarar inte",
  ...
  "desktop.wsl.error.installHarness": "Installationen av GlassPane Harness misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.harnessMissing": "glasspane-harness är inte installerat i den här distributionen",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness är installerat men kunde inte köras",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i glasspane-harness.json",
  ...
  "dialog.server.description": "Växla vilken GlassPane Harness-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingHarness": "Kontrollerar GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Kontrollerar GlassPane Harness i {{distro}}...",
  "wsl.onboarding.updatingHarness": "Uppdaterar GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Uppdaterar GlassPane Harness i {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Uppdatera GlassPane Harness i {{distro}}.",
  "wsl.onboarding.updateHarness": "Uppdatera GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness är redo i {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness är redo.",
  "wsl.onboarding.installHarnessIn": "Installera GlassPane Harness i {{distro}}.",
  "wsl.onboarding.installHarness": "Installera GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan GlassPane Harness kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan GlassPane Harness igen.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av GlassPane Harness ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till GlassPane Harness-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (glasspane-harness.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, GlassPane Harness stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör GlassPane Harness-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Anpassa hur GlassPane Harness ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om GlassPane Harness följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa GlassPane Harnesss tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när GlassPane Harness startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av GlassPane Harness.",
