...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Plugins configured in glasspane-harness.json",
  ...
  "dialog.server.description": "Switch which GlassPane Harness server this app connects to.",
  ...
  "wsl.onboarding.checkingHarness": "Checking GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Checking GlassPane Harness in {{distro}}...",
  "wsl.onboarding.updatingHarness": "Updating GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Updating GlassPane Harness in {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Update GlassPane Harness in {{distro}}.",
  "wsl.onboarding.updateHarness": "Update GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness is ready in {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness is ready.",
  "wsl.onboarding.installHarnessIn": "Install GlassPane Harness in {{distro}}.",
  "wsl.onboarding.installHarness": "Install GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before GlassPane Harness can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of GlassPane Harness ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the GlassPane Harness team",
  ...
  "error.chain.checkConfig": "Check your config (glasspane-harness.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, GlassPane Harness does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the GlassPane Harness server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for GlassPane Harness",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how GlassPane Harness looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether GlassPane Harness follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how GlassPane Harness is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when GlassPane Harness launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of GlassPane Harness.",
