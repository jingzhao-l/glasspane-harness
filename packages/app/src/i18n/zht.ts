...
export const dict = {
  ...
  "desktop.menu.documentation": "GlassPane Harness 文件",
  "desktop.menu.supportForum": "支援論壇",
  "desktop.menu.shareFeedback": "提供意見回饋",
  "desktop.menu.reportBug": "回報錯誤",
  "desktop.menu.ariaLabel": "GlassPane Harness 選單",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness 載入失敗",
  "desktop.recovery.terminated": "GlassPane Harness 視窗意外終止",
  "desktop.recovery.unresponsive": "GlassPane Harness 沒有回應",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.harnessMissing": "此發行版中未安裝 glasspane-harness",
  "desktop.wsl.error.harnessCannotRun": "已安裝 glasspane-harness，但無法執行",
  "desktop.wsl.error.harnessNotInstalled": "{{distro}} 中未安裝 GlassPane Harness",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "GlassPane Harness 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 GlassPane Harness 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 GlassPane Harness 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 GlassPane Harness 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 glasspane-harness.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 GlassPane Harness 伺服器。",
  ...
  "wsl.onboarding.checkingHarness": "正在檢查 GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "正在檢查 {{distro}} 中的 GlassPane Harness...",
  ...
  "wsl.onboarding.harnessReadyIn": "{{distro}} 中的 GlassPane Harness 已就緒。",
  "wsl.onboarding.harnessReady": "GlassPane Harness 已就緒。",
  "wsl.onboarding.installHarnessIn": "在 {{distro}} 中安裝 GlassPane Harness。",
  "wsl.onboarding.installHarness": "安裝 GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "未安裝 GlassPane Harness",
  ...
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 GlassPane Harness。",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "GlassPane Harness 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 GlassPane Harness 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (glasspane-harness.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：GlassPane Harness 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 GlassPane Harness 伺服器。",
  ...
  "settings.general.row.language.description": "變更 GlassPane Harness 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 GlassPane Harness 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 GlassPane Harness 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 GlassPane Harness 的主題。",
  ...
  "settings.updates.row.startup.description": "在 GlassPane Harness 啟動時自動檢查更新",
