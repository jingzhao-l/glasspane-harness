export const dict = {
  ...
  "desktop.menu.documentation": "Documentație GlassPane Harness",
  ...
  "desktop.menu.ariaLabel": "Meniu GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra GlassPane Harness s-a închis neașteptat",
  "desktop.recovery.unresponsive": "GlassPane Harness nu răspunde",
  ...
  "desktop.wsl.error.installHarness": "Instalarea GlassPane Harness a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.harnessMissing": "glasspane-harness nu este instalat în această distribuție",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea GlassPane Harness s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în glasspane-harness.json",
  ...
  "dialog.server.description": "Schimbă serverul GlassPane Harness la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingHarness": "Se verifică GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Se verifică GlassPane Harness în {{distro}}...",
  "wsl.onboarding.updatingHarness": "Se actualizează GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Se actualizează GlassPane Harness în {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Actualizează GlassPane Harness în {{distro}}.",
  "wsl.onboarding.updateHarness": "Actualizează GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness este gata în {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness este gata.",
  "wsl.onboarding.installHarnessIn": "Instalează GlassPane Harness în {{distro}}.",
  "wsl.onboarding.installHarness": "Instalează GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca GlassPane Harness să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune GlassPane Harness ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei GlassPane Harness",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (glasspane-harness.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, GlassPane Harness nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul GlassPane Harness în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul GlassPane Harness pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă GlassPane Harness urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea GlassPane Harness",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune GlassPane Harness.",
