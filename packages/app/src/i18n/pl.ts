export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać GlassPane Harness",
  "desktop.recovery.terminated": "Okno GlassPane Harness zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "GlassPane Harness nie odpowiada",
  ...
  "desktop.wsl.error.installHarness": "Nie udało się zainstalować GlassPane Harness",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.harnessMissing": "Program glasspane-harness nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.harnessCannotRun": "Program glasspane-harness jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja GlassPane Harness została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku glasspane-harness.json",
  ...
  "dialog.server.description": "Przełącz serwer GlassPane Harness, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingHarness": "Sprawdzanie GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Sprawdzanie GlassPane Harness w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingHarness": "Aktualizowanie GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Aktualizowanie GlassPane Harness w dystrybucji {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Zaktualizuj GlassPane Harness w dystrybucji {{distro}}.",
  "wsl.onboarding.updateHarness": "Zaktualizuj GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness jest gotowy.",
  "wsl.onboarding.installHarnessIn": "Zainstaluj GlassPane Harness w dystrybucji {{distro}}.",
  "wsl.onboarding.installHarness": "Zainstaluj GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim GlassPane Harness będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja GlassPane Harness ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu GlassPane Harness",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (glasspane-harness.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: GlassPane Harness nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer GlassPane Harness wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd GlassPane Harness na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy GlassPane Harness ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw GlassPane Harness.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania GlassPane Harness",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji GlassPane Harness.",
