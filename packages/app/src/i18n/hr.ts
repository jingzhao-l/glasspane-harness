...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u glasspane-harness.json",
  ...
  "dialog.server.description": "Promijenite na koji se GlassPane Harness poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingHarnessIn": "Provjera GlassPane Harness u {{distro}}...",
  "wsl.onboarding.updatingHarness": "Ažuriranje GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Ažuriranje GlassPane Harness u {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Ažurirajte GlassPane Harness u {{distro}}.",
  "wsl.onboarding.updateHarness": "Ažurirajte GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness je spreman u {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness je spreman.",
  "wsl.onboarding.installHarnessIn": "Instalirajte GlassPane Harness u {{distro}}.",
  "wsl.onboarding.installHarness": "Instalirajte GlassPane Harness",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što GlassPane Harness može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite GlassPane Harness.",
  ...
  "help.tabs.introduction": "Radna površina GlassPane Harness sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija GlassPane Harness ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku GlassPane Harness timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (glasspane-harness.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, GlassPane Harness još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "GlassPane Harness Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite GlassPane Harness poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako GlassPane Harness izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li GlassPane Harness slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je GlassPane Harness tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se GlassPane Harness pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju GlassPane Harness.",
