export const dict = {
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness laadimine ebaõnnestus",
  "desktop.recovery.terminated": "GlassPane Harness aken suleti ootamatult",
  "desktop.recovery.unresponsive": "GlassPane Harness ei vasta",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.harnessMissing": "glasspane-harness pole sellesse distrosse installitud",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid GlassPane Harness'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis glasspane-harness.json",
  ...
  "dialog.server.description": "Lülitage, millise GlassPane Harness serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingHarness": "GlassPane Harness kontrollimine...",
  "wsl.onboarding.checkingHarnessIn": "GlassPane Harness kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingHarness": "GlassPane Harness värskendamine...",
  "wsl.onboarding.updatingHarnessIn": "GlassPane Harness värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Värskenda GlassPane Harness jaotises {{distro}}.",
  "wsl.onboarding.updateHarness": "Värskenda GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness on valmis {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness on valmis.",
  "wsl.onboarding.installHarnessIn": "Installige GlassPane Harness asukohta {{distro}}.",
  "wsl.onboarding.installHarness": "Installige GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui GlassPane Harness saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse GlassPane Harness ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast GlassPane Harness meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (glasspane-harness.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, GlassPane Harness ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "GlassPane Harness Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage GlassPane Harness server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke GlassPane Harness kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas GlassPane Harness teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas GlassPane Harness järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas GlassPane Harness on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui GlassPane Harness käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse GlassPane Harness uusimat versiooni.",
