export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za GlassPane Harness",
  ...
  "desktop.menu.ariaLabel": "GlassPane Harness meni",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor GlassPane Harness-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "GlassPane Harness ne reaguje",
  ...
  "desktop.wsl.error.installHarness": "Instalacija GlassPane Harness-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.harnessMissing": "glasspane-harness nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje GlassPane Harness-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u GlassPane Harness-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u GlassPane Harness-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u GlassPane Harness-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u glasspane-harness.json",
  ...
  "dialog.server.description": "Promijeni na koji se GlassPane Harness server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingHarness": "Provjera GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Provjera GlassPane Harness u distribuciji {{distro}}...",
  "wsl.onboarding.updatingHarness": "Ažuriranje GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Ažuriranje GlassPane Harness u distribuciji {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Ažuriraj GlassPane Harness u distribuciji {{distro}}.",
  "wsl.onboarding.updateHarness": "Ažuriraj GlassPane Harness",
  "wsl.onboarding.harnessReadyIn": "GlassPane Harness je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.harnessReady": "GlassPane Harness je spreman.",
  "wsl.onboarding.installHarnessIn": "Instaliraj GlassPane Harness u distribuciji {{distro}}.",
  "wsl.onboarding.installHarness": "Instaliraj GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi GlassPane Harness mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori GlassPane Harness.",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija GlassPane Harness-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku GlassPane Harness timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (glasspane-harness.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: GlassPane Harness još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni GlassPane Harness server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u GlassPane Harness-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako GlassPane Harness izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li GlassPane Harness prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu GlassPane Harness-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se GlassPane Harness pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju GlassPane Harness-a.",
