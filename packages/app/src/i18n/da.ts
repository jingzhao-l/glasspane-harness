export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af GlassPane Harness",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i GlassPane Harness.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i GlassPane Harness.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i GlassPane Harness.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i glasspane-harness.json",
  ...
  "dialog.server.description": "Skift hvilken GlassPane Harness-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingHarness": "Tjekker GlassPane Harness...",
  "wsl.onboarding.checkingHarnessIn": "Tjekker GlassPane Harness i {{distro}}...",
  "wsl.onboarding.updatingHarness": "Opdaterer GlassPane Harness...",
  "wsl.onboarding.updatingHarnessIn": "Opdaterer GlassPane Harness i {{distro}}...",
  "wsl.onboarding.updateHarnessIn": "Opdater GlassPane Harness i {{distro}}.",
  "wsl.onboarding.updateHarness": "Opdater GlassPane Harness",
  ...
  "wsl.onboarding.distroStatus.harnessMissing": "GlassPane Harness er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før GlassPane Harness kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "GlassPane Harness kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter GlassPane Harness igen.",
  ...
  "toast.update.description": "En ny version af GlassPane Harness ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til GlassPane Harness-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (glasspane-harness.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, GlassPane Harness understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "GlassPane Harness inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør GlassPane Harness-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for GlassPane Harness",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan GlassPane Harness ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om GlassPane Harness skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas GlassPane Harnesss tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når GlassPane Harness starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af GlassPane Harness.",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness kunne ikke indlæses",
  "desktop.recovery.terminated": "GlassPane Harness-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installHarness": "Installationen af GlassPane Harness mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.harnessMissing": "glasspane-harness er ikke installeret i denne distribution",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness er installeret, men kunne ikke køre",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af GlassPane Harness er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "GlassPane Harness Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
