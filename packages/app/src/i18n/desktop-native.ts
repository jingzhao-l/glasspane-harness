...
export const DESKTOP_NATIVE_ENGLISH = {
  "desktop.menu.app": "GlassPane Harness",
  ...
  "desktop.recovery.loadFailed": "GlassPane Harness failed to load",
  "desktop.recovery.terminated": "GlassPane Harness window terminated unexpectedly",
  "desktop.recovery.unresponsive": "GlassPane Harness is not responding",
  ...
  "desktop.wsl.error.installHarness": "GlassPane Harness installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.harnessMissing": "glasspane-harness is not installed in this distro",
  "desktop.wsl.error.harnessCannotRun": "glasspane-harness is installed but could not run",
  "desktop.wsl.error.harnessNotInstalled": "GlassPane Harness is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "GlassPane Harness update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
