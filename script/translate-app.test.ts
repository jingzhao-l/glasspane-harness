...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".glasspane-harness/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".glasspane-harness/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".glasspane-harness/glossary/zh-tw.md")
  })
